...
@NamedQueries(value = {
		...
		@NamedQuery(name = "BookRatingComments.findByBookISBN", query = "from BookRatingComments b where b.isbn = :isbn and b.bookComments is not null order by b.bookCommentDate desc")
		})
