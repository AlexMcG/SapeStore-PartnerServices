		...
		<form:form name="form" action="/SapeStore/bookListByCat?categoryId=${categoryId}&categoryName=${categoryName}&checkMe=false" method="GET" commandName="welcome">
			...
			<div class="leftCol">
				...
				<nav> <!-- left navigation -->
         		...
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=1&categoryName=Academic and Professional&checkMe=false" title="Academic and Professional" >
       				Academic and Professional</a>
         		</li>
      	
         		<li 
         		
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=2&categoryName=Business and Management&checkMe=false" title="Business and Management" >
         		...
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=3&categoryName=Comics and Graphic Novels&checkMe=false" title="Comics and Graphic Novels" >
       				Comics and Graphic Novels</a>
         		</li>
      	
         		<li 
         		
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=4&categoryName=Computers and Internet&checkMe=false" title="Computers and Internet" >
         		...
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=5&categoryName=Food and Wine&checkMe=false" title="Food and Wine" >
       				Food and Wine</a>
         		</li>
         		...
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=6&categoryName=Health&checkMe=false" title="Health" >
       				Health</a>
         		</li>
         		...
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=7&categoryName=History and Politics&checkMe=false" title="History and Politics" >
         		...
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=8&categoryName=Literature and Fiction&checkMe=false" title="Literature and Fiction" >
       				Literature and Fiction</a>
         		</li>
      	
         		<li 
         		
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=9&categoryName=Music Films and Entertainment&checkMe=false" title="Music Films and Entertainment" >
       				Music Films and Entertainment</a>
         		</li>
      	
         		<li 
         		
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=10&categoryName=Religion and Spirituality&checkMe=false" title="Religion and Spirituality" >
         		...
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=11&categoryName=Science and Technology&checkMe=false" title="Science and Technology" >
         		...
         		>
       				<a href="/SapeStore/bookListByCat?categoryId=12&categoryName=Sports and Games&checkMe=false" title="Sports and Games" >
       				Sports and Games</a>
         		</li>
...
<script src="js/predicitiveSearch.js"></script>
</body>
</html>