    ...
    <div id="header"> <a href="/SapeStore/manageInventory" title="SapeStore" class="logo"><img src="img/logo.jpg" width="231" height="109" alt="SapeStore"></a>
      ...
      <nav>
        <ul class="nav">
					...
					<li  class="active"><a href="/SapeStore/adminReport">Manage Reports</a></li> 
  ...
  <!-- header ends -->
    ...
    <div id="tabs" style="border: none; height: 650px;">
	  <ul style="padding-top: 20px; padding-left: 22px; padding-right: 3px;">
	  	<li><a href="/SapeStore/purchasedRentedReport" style="outline: none">Purchased/Rented</a></li>
		<li><a href="/SapeStore/defaultersReport" style="outline: none">Defaulters</a></li>
	  </ul>
	</div>
